...
plt.title("Fundamental Frequency (f0) Patterns Across Focus Conditions\n[Athlone Irish English]", 
          fontsize=14, pad=20)
plt.xlabel("Measurement Points (Syllable Position × Time Point)", fontsize=12, labelpad=15)
...
# 添加箭头标注趋势
plt.annotate('Focus Peaking', xy=(0, 237), xytext=(0.5, 250),
             arrowprops=dict(facecolor='black', arrowstyle='->'),
             fontsize=10)
plt.annotate('Post-Focus Compression', xy=(2, 144), xytext=(2.5, 100),
             arrowprops=dict(facecolor='black', arrowstyle='->'),
             fontsize=10)
